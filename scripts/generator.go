...
func (ag *arrangement) Y2026() {
	...
	ag.yearAt(2026).
		...
		sf().rest(2, 15).to(2, 23).work(2, 14).work(2, 28).inLieu(2, 20).inLieu(2, 23).
		tsd().rest(4, 4).to(4, 6).
		ld().rest(5, 1).to(5, 5).work(5, 9).inLieu(5, 5).
		dbf().rest(6, 19).to(6, 21).
		maf().rest(9, 25).to(9, 27).
		nd().rest(10, 1).to(10, 7).work(9, 20).work(10, 10).inLieu(10, 6).to(10, 7)
}
